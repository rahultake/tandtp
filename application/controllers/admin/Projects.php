...
class Projects extends AdminController
{
    ...
    public function project($id = '')
    {
        ...
        if ($id == '') {
            ...
            $this->db->select('*');
            $this->db->from('tblproject_sub_contractor');
            $this->db->where('proj_id', $id);
            $data['project_sub_contractors'] = $this->db->get()->result();
            $data['selected_sub_contractor_ids'] = array_map(function($sub_contractor) {
                return $sub_contractor->sub_contractor_id;
            }, $data['project_sub_contractors']);
        }
