...
function app_init_admin_sidebar_menu_items()
{
    ...
    // $CI->app_menu->add_sidebar_menu_item('solution-categories', [
    //     'name'     => _l('Solution Categories'),
    //     'href'     => admin_url('solution-categories'),
    //     'position' => 1,
    //     'icon'     => 'fa fa-sitemap',
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_menu_item('solution-matrix', [
    //     'name'     => _l('Solution Matrix'),
    //     'href'     => admin_url('solution-matrix'),
    //     'position' => 1,
    //     'icon'     => 'fa fa-th',
    //     'badge'    => [],
    // ]);
    ...
    $CI->app_menu->add_sidebar_menu_item('sub-contractor', [
        'name'     => _l('Sub Contractor'),
        'href'     => admin_url('sub-contractor'),
