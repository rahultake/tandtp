...
class Projects_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        $sub_contractor_ids = $data['sub_contractor_id'] ?? [];
        ...
        if ($insert_id) {
            ...
            $this->add_sub_contractors_to_project($insert_id, $sub_contractor_ids);
    ...
    public function update($data, $id)
    {
        ...
        $this->update_sub_contractors_for_project($id, $sub_contractor_ids);
        if ($affectedRows > 0) {            
    ...
    public function add_sub_contractors_to_project($project_id, $sub_contractor_ids)
    {
        if (!empty($sub_contractor_ids)) {
            foreach ($sub_contractor_ids as $sub_contractor_id) {
                $this->db->insert('tblproject_sub_contractor', [
                    'proj_id' => $project_id,
    ...
    public function update_sub_contractors_for_project($project_id, $sub_contractor_ids)
    {
        if (!empty($sub_contractor_ids)) {
            $this->db->where('proj_id', $project_id);
            $this->db->delete('tblproject_sub_contractor');

            // Insert updated subcontractors
            foreach ($sub_contractor_ids as $sub_contractor_id) {
                $this->db->insert('tblproject_sub_contractor', [
                    'proj_id' => $project_id,
                    'sub_contractor_id' => $sub_contractor_id
