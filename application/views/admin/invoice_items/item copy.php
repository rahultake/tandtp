                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <label><input type="radio" value="Item" name="item_type" checked > Item</label>
                            <label><input type="radio" value="Accessory" name="item_type" > Accessory</label>
                        </div>
                        <div class="form-group">
                            <span>
                                <?php echo render_select('parent_item_id', $items, ['id', 'description'], 'Parent Item', $itemid); ?>
                            </span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="rate" class="control-label">
                                ...
                                <?php echo _l('invoice_item_add_edit_rate_currency', $base_currency->symbol . ' <small>(' . _l('base_currency_string') . ')</small>'); ?>
                            </label>
                        ...
                        ?>
                        <div class="row">
                            Display as GST and add HSN Code
                            <div class="col-md-6">
                             <div class="form-group">
