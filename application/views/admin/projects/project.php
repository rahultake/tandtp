                    ...
                    <div class="panel-body">
                        ...
                        ?>
                             ...
                             if ($selected != '') {
                                ...
                                <div class="form-group select-placeholder">
                                    <label for="item_id">Select Sub Contractors</label>
                                    <div class="clearfix"></div>
                                    <select name="sub_contractor_id[]" class="selectpicker" data-width="100%" multiple data-live-search="true" data-actions-box="true" title="Choose sub contractor">
                                        <?php foreach ($sub_contractors as $sub_contractor) : ?>    
                                        <option value="<?php echo $sub_contractor->id; ?>" <?php echo in_array($sub_contractor->id, $selected_sub_contractor_ids) ? 'selected' : ''; ?>><?php echo $sub_contractor->sub_contractor_name; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
