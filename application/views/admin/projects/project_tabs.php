...
<div class="horizontal-scrollable-tabs tw-bg-white tw-shadow-sm tw-rounded-lg tw-px-3 tw-min-h-0">
    ...
    <div class="horizontal-tabs">
        <ul class="nav nav-tabs tw-mb-0 project-tabs nav-tabs-horizontal tw-border-b-0" role="tablist">
            <li class="project_tab_project_overview tw-py-2"><a href="<?php echo admin_url('boq/'.$project->id);?>" class="tw-py-2"> <i class="fa fa-file"></i> 
            <span
                        class="pull-right mleft5">BOQ </span></a></li>
            <?php
        foreach (filter_project_visible_tabs($tabs, $project->settings->available_features) as $key => $tab) {
            ...
            <li class="project_tab_project_overview tw-py-2"><a href="<?php echo admin_url('inventory/'.$project->id);?>" class="tw-py-2"> <i class="fa fa-file"></i> 
            <span class="pull-right mleft5">Inventory </span></a></li>
            <li class="project_tab_project_overview tw-py-2"><a href="<?php echo admin_url('sub-contractor/projects/'.$project->id);?>" class="tw-py-2"> <i class="fa fa-file"></i> 
            <span class="pull-right mleft5">Sub Contractor </span></a></li>
        </ul>
    </div>
</div>