                ...
                <div class="_buttons">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right">
                            ...
                            <a href="<?php echo admin_url('project-locations/'.$project->id);?>" class="btn btn-success btn-sm"> <i class="fa fa-map-marker"></i> Locations </a>
                            <a href="<?php echo admin_url('solution-matrix/'.$project->id);?>" class="btn btn-warning btn-sm"> <i class="fa fa-th"></i> Matrix </a>
                           ...
                           ?>
                            ...
                            <a href="#"
                                ...
                                class="invoice-project btn-sm btn btn-primary<?php if ($project->client_data->active == 0) {
                               echo ' disabled';
                           } ?>">
