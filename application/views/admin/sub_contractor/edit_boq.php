...
<div id="wrapper" class="boq">
    <div class="content">
        <div class="row">
            ...
            <div class="panel_s">
                <?php $boq_query_string = isset($boqs[0]->id)?'/'.$boqs[0]->id:'';?>
                <?php echo form_open('admin/sub-contractor/edit_boq/'.$sub_contractor_id.$boq_query_string); ?>
                    <div class="panel-heading">
                    <h3 class="m-10">BOQ <div class="label label-primary"><?php echo $sub_contractor[0]->sub_contractor_name?></div></h3>
                    </div>
                    <div class="panel-body">
                        
                            <label for="boq_title">Title:</label>
                            <input class="form-control" type="text" name="boq_title" required value="<?php echo $boqs[0]->boq_title; ?>">
                            
                            <label for="remarks">Remarks:</label>
                            <textarea class="form-control" name="remarks" required><?php echo $boqs[0]->remarks; ?></textarea>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped boq-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control item_qty" name="boq_item_qty[]" value="<?php echo $boq_item->sub_contractor_qty?>" ></td>
                                        <td><input type="number" class="form-control boq-item-price" name="boq_item_price[]" value="<?php echo $boq_item->sub_contractor_price?>" ></td>
                                        <td class="text-right amount"><?php echo ($boq_item->sub_contractor_qty * $boq_item->sub_contractor_price)?></td>
