            ...
            <div class="col-md-12">
                ...
                <div class="panel_s tw-mt-2 sm:tw-mt-4">
                    <div class="panel-heading">
                        <h4>Sub Contractors Against Project</h4>
                    </div>
                        ...
                        <table id="subcontractorTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php foreach ($sub_contractors as $sub_contractor) : ?>
                                    <tr>
                                        <td>#<?php echo sprintf("%04d",$sub_contractor->sub_id); ?></td>
                                        <td><?php echo $sub_contractor->sub_contractor_name; ?></td>
                                        <td><?php echo $sub_contractor->sub_contractor_description; ?></td>
                                        <td>
                                            <a class="btn-sm btn btn-success" href="<?php echo admin_url('sub-contractor/track-material-issue/' . $project_id.'/'. $sub_contractor->sub_id); ?>" title="Track Material Issue">Track Material Issue</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
