...
function add_item_to_preview(e) {
    requestGetJSON("invoice_items/get_item_by_id/" + e).done(function (e) {
        clear_item_preview_values(), $('.main input[name="item_id"]').val(e.itemid);
...
function add_item_to_table(e, t, a, i) {
    if ("" !== (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e).description || "" !== e.long_description || "" !== e.rate) {
        // var item_id = parseInt($('.main input[name="item_id"]').val());
        var item_id = parseInt($('#item_id').val());
        var str_item_id = "";
        if(item_id>0){
            str_item_id = "<input type='hidden1' name='item_id[]' value='"+item_id+"'>";
        }
        var n = "",
        ...
        return (
            get_taxes_dropdown_template(l, e.taxname).done(function (a) {
                (n += '<input type="hidden" class="order" name="newitems[' + s + '][order]">'),
                    (n += "</td>"),
                    (n += '<td class="bold description">'+str_item_id+'<textarea name="newitems[' + s + '][description]" class="form-control" rows="5">' + e.description + "</textarea></td>"),
