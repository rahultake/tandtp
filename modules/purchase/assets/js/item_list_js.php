...
function edit_commodity_item(invoker){
  ...
  $('#commodity_list-add-edit').modal('show');
      ...
      $('#commodity_list-add-edit input[name="unit"]').val($(invoker).data('unit'));
      $('#commodity_list-add-edit input[name="item_duration"]').val($(invoker).data('item_duration'));
  ...
  function new_commodity_item(){
    ...
    $('#commodity_list-add-edit').modal('show');
      ...
      $('#commodity_list-add-edit input[name="unit"]').val('');
      $('#commodity_list-add-edit input[name="item_duration"]').val('');
