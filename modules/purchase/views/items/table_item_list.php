...
foreach ($rResult as $aRow) {
    ...
    $row[] = $_data;
    $date_added = $aRow['date_added'];
    $item_duration = intval($aRow['item_duration']);
    $date = new DateTime("+" . $item_duration . " days $date_added");
    $today = new DateTime();
