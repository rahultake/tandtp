...
<body class="web-to-lead <?php echo html_entity_decode($form->form_key); ?>"<?php if (is_rtl(true)) {echo ' dir="rtl"';}?>>
  <div class="container-fluid">
    <div class="row">
      <div class="<?php if ($this->input->get('col')) {echo html_entity_decode($this->input->get('col'));} else {echo 'col-md-12';}?>">
        <div id="response"></div>
        <?php echo form_open_multipart(admin_url() . 'recruitment/add_candidate_form_recruitment_channel/' . $form->form_key); ?>
